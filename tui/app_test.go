...
// detail view for the currently selected posting, running the
// application-documents load to completion (see
// loadApplicationDocuments) so the detail view reflects it immediately.
